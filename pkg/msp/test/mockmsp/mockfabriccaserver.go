...
func (s *MockFabricCAServer) Start(lis net.Listener, cryptoSuite core.CryptoSuite) {
	...
	http2.HandleFunc("/register", s.register)
	http2.HandleFunc("/enroll", s.enroll)
	http2.HandleFunc("/reenroll", s.enroll)
	http2.HandleFunc("/revoke", s.revoke)
	http2.HandleFunc("/identities", s.identities)
	http2.HandleFunc("/identities/123", s.identity)
	http2.HandleFunc("/affiliations", s.affiliations)
	http2.HandleFunc("/affiliations/123", s.affiliation)
	http2.HandleFunc("/cainfo", s.cainfo)
...
// Register user
func (s *MockFabricCAServer) register(w http2.ResponseWriter, req *http2.Request) {
...
// Revoke user
func (s *MockFabricCAServer) revoke(w http2.ResponseWriter, req *http2.Request) {
...
// Enroll user
func (s *MockFabricCAServer) enroll(w http2.ResponseWriter, req *http2.Request) {
...
// Register user
func (s *MockFabricCAServer) identity(w http2.ResponseWriter, req *http2.Request) {
	switch req.Method {
...
func (s *MockFabricCAServer) identities(w http2.ResponseWriter, req *http2.Request) {
	switch req.Method {
...
func (s *MockFabricCAServer) affiliations(w http2.ResponseWriter, req *http2.Request) {
	switch req.Method {
	case http2.MethodPost:
...
func (s *MockFabricCAServer) affiliation(w http2.ResponseWriter, req *http2.Request) {
	switch req.Method {
	case http2.MethodGet:
		resp := &api.AffiliationResponse{AffiliationInfo: api.AffiliationInfo{Name: "test1.com"}}
		if err := cfsslapi.SendResponse(w, resp); err != nil {
...
func (s *MockFabricCAServer) cainfo(w http2.ResponseWriter, req *http2.Request) {
	switch req.Method {
	case http2.MethodPost:
