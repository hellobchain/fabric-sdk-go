...
var hashOIDs = map[x509.Hash]asn1.ObjectIdentifier{
	...
	x509.SM3:    asn1.ObjectIdentifier([]int{1, 2, 156, 10197, 1, 401, 1}),
}
...
var signatureAlgorithmDetails = []struct {
	...
	{x509.SM2WithSHA1, oidSignatureSM2WithSHA1, x509.SM2, x509.SHA1},
	{x509.SM2WithSHA256, oidSignatureSM2WithSHA256, x509.SM2, x509.SHA256},
}
