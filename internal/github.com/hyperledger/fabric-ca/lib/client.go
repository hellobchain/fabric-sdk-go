...
func (c *Client) initHTTPClient(serverName string) error {
	...
	c.httpClient = &http2.Client{Transport: tr}
	return nil
}
...
func (c *Client) newGet(endpoint string) (*http2.Request, error) {
	curl, err := c.getURL(endpoint)
	if err != nil {
		return nil, err
	}
	req, err := http2.NewRequest("GET", curl, bytes.NewReader([]byte{}))
	if err != nil {
...
func (c *Client) newPut(endpoint string, reqBody []byte) (*http2.Request, error) {
	curl, err := c.getURL(endpoint)
	if err != nil {
		return nil, err
	}
	req, err := http2.NewRequest("PUT", curl, bytes.NewReader(reqBody))
	if err != nil {
...
func (c *Client) newDelete(endpoint string) (*http2.Request, error) {
	curl, err := c.getURL(endpoint)
	if err != nil {
		return nil, err
	}
	req, err := http2.NewRequest("DELETE", curl, bytes.NewReader([]byte{}))
	if err != nil {
...
func (c *Client) newPost(endpoint string, reqBody []byte) (*http2.Request, error) {
	curl, err := c.getURL(endpoint)
	if err != nil {
		return nil, err
	}
	req, err := http2.NewRequest("POST", curl, bytes.NewReader(reqBody))
	if err != nil {
...
func (c *Client) SendReq(req *http2.Request, result interface{}) (err error) {
...
func (c *Client) StreamResponse(req *http2.Request, stream string, cb func(*json.Decoder) error) (err error) {
...
func newCfsslKeyRequest(bkr *api.KeyRequest) *csr.BasicKeyRequest {
