...
func (msp *bccspmsp) validateTLSCAIdentity(cert *x5092.Certificate, opts *x5092.VerifyOptions) error {
	if !cert.IsCA {
		return errors.New("Only CA identities can be validated")
	}
...
func (msp *bccspmsp) validateIdentityAgainstChain(id *identity, validationChain []*x5092.Certificate) error {
	return msp.validateCertAgainstChain(id.cert, validationChain)
}

func (msp *bccspmsp) validateCertAgainstChain(cert *x5092.Certificate, validationChain []*x5092.Certificate) error {
...
func (msp *bccspmsp) getValidityOptsForCert(cert *x5092.Certificate) x5092.VerifyOptions {
	...
	var tempOpts x5092.VerifyOptions
...
func getSubjectKeyIdentifierFromCert(cert *x5092.Certificate) ([]byte, error) {
	var SKI []byte
